...
app.use((_req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      ...
      "connect-src 'self' https://*.plaid.com https://*.supabase.co wss://*.supabase.co https://www.google.com https://www.gstatic.com https://www.google-analytics.com https://www.googletagmanager.com https://api.emailjs.com https://generativelanguage.googleapis.com https://*.googleapis.com",
      "frame-src 'self' https://cdn.plaid.com https://*.plaid.com https://www.google.com https://www.gstatic.com https://calendly.com",
  ...
  res.setHeader(
    'Permissions-Policy',
    'camera=(self "https://cdn.plaid.com"), microphone=(), geolocation=(self), encrypted-media=*, accelerometer=(self "https://cdn.plaid.com")'
  );
